    ...
    <SectionWrapper id="proof" className="bg-white/5">
      <div ref={containerRef} className="max-w-6xl mx-auto w-full relative z-10">
        <div className="mb-16 text-center md:text-left">
           <span className="text-primary text-sm tracking-widest uppercase">05 / Etki</span>
           <h2 className="text-4xl md:text-5xl font-serif mt-4">Kanıtlanmış Sonuçlar</h2>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-white/10 pt-12">
           {[
             { label: "Lansmanı Yapılan Markalar", value: "50+" },
             { label: "Giriş Yapılan Pazarlar", value: "12" },
             { label: "Üretilen Gelir", value: "$100M+" },
             { label: "Kazanılan Ödüller", value: "25" }
           ].map((stat, i) => (
        ...
        <div className="mt-24 p-12 border border-white/10 bg-black/40 backdrop-blur-md rounded-sm relative">
           <div className="text-2xl md:text-3xl font-serif italic text-white/80 leading-relaxed">
             &quot;Mundus sadece lansman yapmamıza yardımcı olmadı; kim olduğumuzu tanımlamamıza yardımcı oldu. Stratejik içgörüleri sektörde eşsiz.&quot;
           </div>
           <div className="mt-8 flex items-center gap-4">
              <div className="w-12 h-12 bg-white/20 rounded-full" />
              <div>
                 <div className="font-bold">Elena Rossi</div>
                 <div className="text-sm text-primary">Kurucu, Vesper Spirits</div>
              </div>
           </div>
