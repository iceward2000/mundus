...
export default function Hero() {
  ...
  return (
    <SectionWrapper
      id="hero"
      className="relative items-center overflow-hidden !py-0 max-md:pt-[calc(env(safe-area-inset-top)+5rem)] min-h-[100svh] justify-end pb-10 text-center md:!py-20 md:min-h-screen md:justify-center md:pb-0"
    >
      ...
      <div ref={containerRef} className="relative z-10 flex flex-col items-center pt-0 md:pt-24 lg:pt-28">
        <h1 ref={titleRef} className="m-0 leading-none w-[260px] md:w-[400px] lg:w-[580px] xl:w-[720px]">
          <img
