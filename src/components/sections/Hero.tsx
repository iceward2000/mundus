...
export default function Hero() {
  ...
  return (
    <SectionWrapper
      id="hero"
      className="relative items-center overflow-hidden !py-0 pt-34 min-h-[100svh] justify-end pb-10 text-center md:!py-20 md:pt-0 md:min-h-screen md:justify-center md:pb-0"
    >
