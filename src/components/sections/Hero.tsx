...
export default function Hero() {
  ...
  return (
    <SectionWrapper
      id="hero"
      className="relative items-center overflow-hidden !py-0 max-md:!pt-[calc(env(safe-area-inset-top)+7rem)] min-h-[100svh] justify-end pb-10 text-center md:!py-20 md:min-h-screen md:justify-center md:pb-0"
    >
